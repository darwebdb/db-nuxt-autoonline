<template>
	<main class="main skeleton-body">
		...
		>
			<div class="container">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item">
						<nuxt-link to="/bekijk-autos">Bekijk Auto's</nuxt-link>
					</li>
					<li
					...
					>
						<nuxt-link
							:to="{path: '/bekijk-autos', query: {category: category.slug}}"
		...
		<div
			class="skel-group main-content mt-3"
			v-else
		>
...
export default {
	...
	methods: {
		getProduct: function () {
			...
			Api.get( `${ baseUrl }/autos/${ this.$route.params.slug }`, {
