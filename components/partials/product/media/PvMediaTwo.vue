    ...
    <div class="sidebar-wrapper">
        <div class="product-slider-container">
            ...
            <PvCarousel
                ...
                :options="baseSlider1"
            >
                <div class="swiper-slide" v-for="item in product.afbeeldingen.reverse()" :key="item.name">
                    <img
        ...
        <!-- <div class="prod-thumbnail show-nav-hover transparent-dots flex-column" ref="thumbRef">
            <div
                class="custom-dot"
                v-for="(item, index) in product.afbeeldingen"
                :key="'meida-two' + index"
...
export default {
	...
	computed: {
		lightBoxMedia: function() {
			return this.product.afbeeldingen.reduce((acc, cur) => {
				return [
					...acc,
					{
						src: `${baseUrl}${cur.url}`,
